...
{
    public interface IDeleteLanguageKeywordBusinessService
    {
		...
		OperationResult DeleteByKeyword(string keyword);
		...
		/// <returns>List of  Language Keyword</returns>
		OperationResult DeleteByKeywordText(string keywordText);
