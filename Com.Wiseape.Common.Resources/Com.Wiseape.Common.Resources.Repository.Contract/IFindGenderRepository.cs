...
{
    public interface IFindGenderRepository
    {
		...
		List<Gender> FindByGenderName(string genderName);
		...
		/// <returns>List of  Gender</returns>
		List<Gender> FindByGenderIcon(string genderIcon);
		...
		/// <returns>List of  Gender</returns>
		List<Gender> FindByLanguageID(string languageID);
